 ...
 */
export const collectionsReadCollectionById = <ThrowOnError extends boolean = false>(options: Options<CollectionsReadCollectionByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<CollectionsReadCollectionByIdResponse, CollectionsReadCollectionByIdError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        responseTransformer: collectionsReadCollectionByIdResponseTransformer,
        url: '/api/v1/collections/{collection_id}',
        ...options
    });
};
