 ...
 */
export const authorsSearchPoems = <ThrowOnError extends boolean = false>(options: Options<AuthorsSearchPoemsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<AuthorsSearchPoemsResponse, AuthorsSearchPoemsError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 * Search poems by any field
 */
export const poemsSearchPoems = <ThrowOnError extends boolean = false>(options: Options<PoemsSearchPoemsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<PoemsSearchPoemsResponse, PoemsSearchPoemsError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
