 ...
 */
export const authorsSearchAuthors = <ThrowOnError extends boolean = false>(options: Options<AuthorsSearchAuthorsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<AuthorsSearchAuthorsResponse, AuthorsSearchAuthorsError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
